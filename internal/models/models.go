...
var Registry = map[string]ModelSpec{
	...
	// OpenAI mock aliases for strict client validation (e.g. Codex CLI v0.151.0)
	"gpt-5.6-sol": {
		ID: "gpt-5.6-sol", Slug: "gpt-5.6-sol", DisplayName: "GPT-5.6 Sol (Gemini 3.7 Flash Backend)",
