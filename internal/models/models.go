...
var Registry = map[string]ModelSpec{
	...
	// OpenAI mock aliases mapped to distinct Gemini modes for seamless TUI model switching
	"gpt-5.5": {
		ID: "gpt-5.5", Slug: "gpt-5.5", DisplayName: "GPT-5.5 (Gemini 3.7 Flash Standard)",
		Object: "model", Created: 1700000000, OwnedBy: "google", Description: "Standard Gemini 3.7 Flash mode",
		Mode: 1, Think: 4, SupportedReasoningLevels: []string{}, ShellType: "default",
		Visibility: "list", SupportedInAPI: true, Priority: 0, SupportVerbosity: false,
		TruncationPolicy: TruncationConfig{Type: "auto"}, ModeString: "chat", IsAlias: true,
	},
	"gpt-5.6-sol": {
		ID: "gpt-5.6-sol", Slug: "gpt-5.6-sol", DisplayName: "GPT-5.6 Sol (Gemini 3.5 Deep Thinking)",
		Object: "model", Created: 1700000000, OwnedBy: "google", Description: "Deep thinking / reasoning mode (Gemini 3.5 Flash Thinking)",
		Mode: 2, Think: 0, SupportedReasoningLevels: []string{}, ShellType: "default",
		Visibility: "list", SupportedInAPI: true, Priority: 0, SupportVerbosity: false,
		TruncationPolicy: TruncationConfig{Type: "auto"}, ModeString: "chat", IsAlias: true,
	},
	"gpt-5.2": {
		ID: "gpt-5.2", Slug: "gpt-5.2", DisplayName: "GPT-5.2 (Gemini 3.1 Pro)",
		Object: "model", Created: 1700000000, OwnedBy: "google", Description: "Pro model (requires session cookies)",
		Mode: 3, Think: 4, SupportedReasoningLevels: []string{}, ShellType: "default",
		Visibility: "list", SupportedInAPI: true, Priority: 0, SupportVerbosity: false,
		TruncationPolicy: TruncationConfig{Type: "auto"}, ModeString: "chat", IsAlias: true,
	...
	"gpt-5.6-terra": {
		ID: "gpt-5.6-terra", Slug: "gpt-5.6-terra", DisplayName: "GPT-5.6 Terra (Gemini Flash Thinking Lite)",
		Object: "model", Created: 1700000000, OwnedBy: "google", Description: "Adaptive depth thinking mode",
		Mode: 5, Think: 4, SupportedReasoningLevels: []string{}, ShellType: "default",
		Visibility: "list", SupportedInAPI: true, Priority: 0, SupportVerbosity: false,
		TruncationPolicy: TruncationConfig{Type: "auto"}, ModeString: "chat", IsAlias: true,
	},
	"gpt-5.6-luna": {
		ID: "gpt-5.6-luna", Slug: "gpt-5.6-luna", DisplayName: "GPT-5.6 Luna (Gemini Flash Lite)",
		Object: "model", Created: 1700000000, OwnedBy: "google", Description: "Lightweight fast mode",
		Mode: 6, Think: 4, SupportedReasoningLevels: []string{}, ShellType: "default",
		Visibility: "list", SupportedInAPI: true, Priority: 0, SupportVerbosity: false,
		TruncationPolicy: TruncationConfig{Type: "auto"}, ModeString: "chat", IsAlias: true,
	},
