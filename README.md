...
## Model Names & Compatibility Mappings
...
- `gemini-3.1-pro` (Requires cookie file for session routing)
- `gemini-flash-lite`
...
To connect OpenAI Codex CLI to `gemini-web-proxy`:

1. Edit your `~/.codex/config.toml` file:
...
2. Export the environment variable and launch Codex:
